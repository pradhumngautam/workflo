...
const Tagcard = ({ src, title, content }: tagprops) => {
  return (
    <div className="h-[123px] w-[363.67px] flex gap-[10px] p-[16px] border-[1px] rounded-[8px] shadow-sm bg-[#FFFFFF]">
      <div className="h-[61] w-[77] mt-2 ">
        <Image src={src} alt="" height={61} width={77} />
      </div>
